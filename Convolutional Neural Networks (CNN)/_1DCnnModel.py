...
from DataPreprocessing import PreprocessInput
#%% 
...
class Model(object):
    ...
    def build_model(self, Input_shape, nb_classes, Params):
        ...
        nb_filters, nb_fConv, nb_fPool = Params[0], Params[1], Params[2]
        self.Params = Params
    ...
    def prediction(self, image, width, height, channels):
        ...
        print 'prob', result
        result = self.model.preduct_classes(image)
